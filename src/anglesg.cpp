...
void anglesg (double az1, double az2, double az3, double el1, double el2, double el3, double Mjd1, double Mjd2, double Mjd3, Matrix *Rs1, Matrix *Rs2, Matrix *Rs3, Matrix &r2, Matrix &v2){
    ...
    Matrix A(3,3);
    A(1,1) = Lm1(1,1); A(1,2) = Lm1(1,2); A(1,3) = Lm1(1,3);
    A(2,1) = Lm2(1,1); A(2,2) = Lm2(1,2); A(2,3) = Lm2(1,3);
    A(3,1) = Lm3(1,1); A(3,2) = Lm3(1,2); A(3,3) = Lm3(1,3);

    Matrix B(3,3);
    B(1,1) = (*Rs1)(1,1); B(1,2) = (*Rs1)(1,2); B(1,3) = (*Rs1)(1,3);
    B(2,1) = (*Rs2)(1,1); B(2,2) = (*Rs2)(1,2); B(2,3) = (*Rs2)(1,3);
    B(3,1) = (*Rs3)(1,1); B(3,2) = (*Rs3)(1,2); B(3,3) = (*Rs3)(1,3);

    Matrix D = A.inverse()*B;
    ...
    while ((abs(rhoold2-rho2) > 1e-12) && (ll <= 0 )) {
        ...
        if (strcmp (error, "ok")  &(copa < M_PI / 180)) {
        ...
        Matrix r2v2(3,2);
        r2v2(1,1) = r2(1,1); r2v2(2,1) = r2(2,1); r2v2(3,1) = r2(3,1);
        r2v2(1,2) = v2(1,1); r2v2(2,2) = v2(2,1); r2v2(3,2) = v2(3,1);
